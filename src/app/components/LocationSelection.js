...
const locations = [
  "Hullingham Hill, Nairobi",
  "South Park, Kajiado",
  "Uhuru Garden, Langata",
]
  ...
  return (
    <Menu as='div' className='w-full h-full flex xl:flex-row'>
      <div className='relative flex-1'>
          ...
          <div className='w-full h-16 xl:h-full flex justify-center xl:justify-start xl:border-r xl:border-black/10'>
            <div className='flex flex-col justify-center'>
              <div className='flex flex-col xl:flex-row items-center xl:gap-x-2 gap-y-2 xl:gap-y-0'>
                <FaMapMarketAlt className='text-accent' /> 
        ...
        {/* Items */}
        <Menu.Items className='dropdown-menu shadow-lg absolute -top-56 xl:top-[90px] left-1/2 xl:left-0 z-10 tranform -translate-x-0 text-sm text-center 
        xl:text-left w-full bg-white max-w-[332px] py-6 rounded-[10px] '>
